...
//
//
// $Id: SimpleDetSteppingVerbose.cc,v 1.1 2010-09-16 16:26:13 gcosmo Exp $
...
SimpleDetSteppingVerbose::SimpleDetSteppingVerbose()
{}
...
void SimpleDetSteppingVerbose::StepInfo()
{
  CopyState();
...
void SimpleDetSteppingVerbose::TrackingStarted()
{
